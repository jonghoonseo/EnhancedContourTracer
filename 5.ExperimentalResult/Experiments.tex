...
\begin{table}[h]
	...
	\begin{tabularx}{0.9\textwidth}{YYY}
		...
		\hline
		\hline
		CPU & Intel Core 2 CPU 6300 1.86 GHz & Intel Pentium 4 1.80GHz \\ \hline
		Memory & 512 MB & 256 MB \\ \hline  
		HDD & Samsung UDMA 133 7,200RPM 8MB Buffer & Hitachi UDMA 100 4,200RPM 2MB Buffer \\ \hline
		O/S & \multicolumn{2}{c}{Microsoft Windows 7} \\ \hline
