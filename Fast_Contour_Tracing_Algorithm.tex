...
\Author{Cheolho Cheong$^{1,\dagger}$, Jonghoon Seo $^{1,\dagger}$, Jinwook Shin $^{1,\dagger}$, Dongchul Kim $^{1,\dagger}$, James Park $^{1,\dagger}$ and Tack-Don Han $^{1,}$*}
...
\keyword{Contour tracing; boundary following; pixel following; verex following; contour resoration; contour representation }
