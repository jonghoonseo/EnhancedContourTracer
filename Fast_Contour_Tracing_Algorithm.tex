...
\Title{Fast Contour-Tracing Algorithm based on Pixel-Following Method for Image Sensors}
...
\address{%
	...
	$^{1}$ Software Platform R\&D Lab., LG Electronics Advanced Research Institute, 19 Yangjae-daero 11 gil, Seocho-gu, Seoul 137-893, Korea;
	E-Mail: jonghoon.seo@lge.com \\

	$^{2}$ Department of Computer Science, Yonsei University, 134 Sinchon-dong Seodaemun-gu, Seoul, Republic of Korea;
	E-mails: seungho.chae@msl.yonsei.ac.kr, jin99foryou@msl.yonsei.ac.kr, dongchul@gmail.com, balgeum00@msl.yonsei.ac.kr
}
...
\keyword{Contour tracing; boundary following; pixel following; \JHMEMO{contour data compression}}
...
\input{2.RelatedWorks/RelatedWorks.tex}
\input{3.Analysis/Analysis.tex}
\input{4.Proposed/ProposedContourTracingAlgorithm.tex}
\input{5.ExperimentalResult/Experiments.tex}
...
Jonghoon Seo contributed to design contour following algorithm and implementation of proposed algorithm. Seungho Chae contributed to design contour restoration method and in charge of experiment process. Jinwook Shim and Dongchul Kim contributed in the writing and revising the paper. Cheolho Cheong guided conventional contour following algorithms and helped to design the proposed algorithm. Tack-Don Han guided the research direction and verified the research results. All authors made substantial contributions in the writing and revision of the paper.
