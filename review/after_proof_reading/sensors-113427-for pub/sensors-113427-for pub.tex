...
\vspace{6pt} 
\acknowledgments{\textbf{Acknowledgments:} This work was supported by the National Research Foundation of Korea~(NRF) grant funded by the Korea government~(MEST) (No. NRF-2012R1A2A2A01014499 and NRF-2015R1A2A1A10055673).}
...
Pavlidis, T.
\newblock {\em Algorithms for Graphics and Image Processing}; Springer-Verlag: Berlin, Germany, 2012.
